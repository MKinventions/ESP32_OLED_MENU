...
#define MainMenuButton 26
#define SubMenuButton 27
#define SelectSubMenuValueButton 13
#define pagesButton 25
...
int pot5Dir_address = 11;
int pot6Dir_address = 12;

byte pot1_value, pot2_value, pot3_value, pot4_value, pot5_value, pot6_value;
byte pot1Dir_value, pot2Dir_value, pot3Dir_value, pot4Dir_value, pot5Dir_value, pot6Dir_value;
...
//  display.display();
  ...
  pot5_value = EEPROM.read(pot5_address);//EEPROM.read(ADDRESS 0-255);
  pot6_value = EEPROM.read(pot6_address);//EEPROM.read(ADDRESS 0-255);
  ...
  pot5Dir_value = EEPROM.read(pot5Dir_address);//EEPROM.read(ADDRESS 0-255);
  pot6Dir_value = EEPROM.read(pot6Dir_address);//EEPROM.read(ADDRESS 0-255);
}
...
void loop() 
{
  ...
  pot5Dir_Type = (pot5Dir_value == 0)?"L":"R";
  pot6Dir_Type = (pot6Dir_value == 0)?"L":"R";
...
//          display.setCursor(0,5);//COL,ROW
//          display.println("---------------------");
          display.setCursor(0,12);display.print("P1:");display.print(pot1_value);
          display.setCursor(44,12);display.print("P2:");display.print(pot2_value);   
          display.setCursor(87,12);display.print("P3:");display.print(pot3_value);
          display.setCursor(0,21);display.print("P4:");display.println(pot4_value);
          display.setCursor(44,21);display.print("P5:");display.println(pot5_value);
          display.setCursor(87,21);display.print("P6:");display.println(pot6_value);  

            switch(MainMenuSelect){
            case 0:
                  display.setCursor(0,40);display.print(" P1");display.print(" P2");display.print(" P3");display.print(" P4");display.print(" P5");display.println(" P6");      
                  display.setCursor(0,55);display.print("Press To Select Menu");
                  display.display();
                  break;       
            case 1:
                  display.setCursor(0,40);display.print(">P1");display.print(" P2");display.print(" P3");display.print(" P4");display.print(" P5");display.print(" P6");      
            ...
            case 5:
                  ...
                  switch(SubMenuSelect){
                         case 0:
                                ...
                                break;
                         case 1:
                                EEPROM.write(pot5_address, 180);
                                display.setCursor(10,55);display.print("=>[180]");display.print("    [255]");
                                display.display(); 
                                break;
                         case 2:
                                EEPROM.write(pot5_address, 255);
                                display.setCursor(10,55);display.print("  [180]");display.print("  =>[255]");
                                display.display(); 
                                break;     
                  }  
            ...
            case 6:
                  ...
                  switch(SubMenuSelect){
                         case 0:
                                ...
                                break;
                         case 1:
                                EEPROM.write(pot6_address, 180);
                                display.setCursor(10,55);display.print("=>[180]");display.print("    [255]");
                                display.display(); 
                                break;
                         case 2:
                                EEPROM.write(pot6_address, 255);
                                display.setCursor(10,55);display.print("  [180]");display.print("  =>[255]");
                                display.display(); 
                                break;     
                  }  
...
void potentiometer_settings(){
          ...
          display.setCursor(0,12);display.print("P1:");display.print(pot1Dir_Type);
          display.setCursor(44,12);display.print("P2:");display.print(pot2Dir_Type);   
          display.setCursor(87,12);display.print("P3:");display.print(pot3Dir_Type);
          display.setCursor(0,21);display.print("P4:");display.println(pot4Dir_Type);
          display.setCursor(44,21);display.print("P5:");display.println(pot5Dir_Type);
          display.setCursor(87,21);display.print("P6:");display.println(pot6Dir_Type);  
        ...
        //                  EEPROM.write(pot1_address, pot1_value);
                            ...
                            break;
                     case 1:
                            EEPROM.write(pot5Dir_address, 0);
                            display.setCursor(10,55);display.print("=>LEFT");display.setCursor(60,55);display.print("  RIGHT");
                            display.display(); 
                            break;
                     case 2:
                            EEPROM.write(pot5Dir_address, 1);
                            display.setCursor(10,55);display.print("  LEFT");display.setCursor(60,55);display.print("=>RIGHT");
                            display.display(); 
                            break;     
              }   
        ...
        //                  EEPROM.write(pot1_address, pot1_value);
                            ...
                            break;
                     case 1:
                            EEPROM.write(pot6Dir_address, 0);
                            display.setCursor(10,55);display.print("=>LEFT");display.setCursor(60,55);display.print("  RIGHT");
                            display.display(); 
                            break;
                     case 2:
                            EEPROM.write(pot6Dir_address, 1);
                            display.setCursor(10,55);display.print("  LEFT");display.setCursor(60,55);display.print("=>RIGHT");
                            display.display(); 
                            break;     
              }   
